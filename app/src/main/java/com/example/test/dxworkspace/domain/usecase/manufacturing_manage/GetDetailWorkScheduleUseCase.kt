...
class GetDetailWorkScheduleUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
) : UseCase<List<WorkScheduleDetailModel>, ParamWorkSchedule>() {
    override suspend fun run(params: ParamWorkSchedule): Either<Failure, List<WorkScheduleDetailModel>> {
        return manufacturingManagerRepository.getAllWorkSchedule(
            params
        )
    }
