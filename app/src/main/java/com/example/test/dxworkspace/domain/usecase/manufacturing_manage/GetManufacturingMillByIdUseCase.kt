...
class GetManufacturingMillByIdUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
): UseCase<ManufacturingMillModel, String>() {
    override suspend fun run(params: String): Either<Failure, ManufacturingMillModel> {
        return manufacturingManagerRepository.getManufacturingMillById(params)
    }
}