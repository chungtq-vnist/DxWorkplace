...
): UseCase< Boolean, Pair<RequestApproveCommand , String>>() {
    override suspend fun run(params: Pair<RequestApproveCommand , String>): Either<Failure,  Boolean> {
       return manufacturingManagerRepository.updateCommand(params.first,params.second)
    }
