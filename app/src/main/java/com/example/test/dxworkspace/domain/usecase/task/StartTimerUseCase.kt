...
import com.example.test.dxworkspace.data.entity.task.StartTimeSheetLogResponseRaw
...
class StartTimerUseCase  @Inject constructor(
    ...
    : UseCase<StartTimeSheetLogResponseRaw,Pair<String,String>>() {
    override suspend fun run(params: Pair<String,String>): Either<Failure, StartTimeSheetLogResponseRaw> {
