...
class GetNumberOfPlanByProgressUseCase @Inject constructor(
    val dashboardManufacturingRepository: DashboardManufacturingRepository,
    val configRepository: ConfigRepository
): UseCase<DashboardManufacturingPlanByProgress, ModelRequestDashboardPlan>() {
    override suspend fun run(params: ModelRequestDashboardPlan): Either<Failure, DashboardManufacturingPlanByProgress> {
        return dashboardManufacturingRepository.getNumberOfPlanByProgress(params.role,params.works,params.fromDate,params.toDate)
    }
