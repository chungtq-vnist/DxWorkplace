...
class CreatedLotsUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
): UseCase< Boolean, List<RequestCreateLot>>() {
    override suspend fun run(params: List<RequestCreateLot>): Either<Failure,  Boolean> {
       return manufacturingManagerRepository.createLots(params)
    }
