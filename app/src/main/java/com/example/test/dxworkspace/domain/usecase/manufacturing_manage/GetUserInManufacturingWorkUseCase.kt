...
class GetUserInManufacturingWorkUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
) : UseCase<List<SubUserBasicModel>, String>() {
    override suspend fun run(params: String): Either<Failure, List<SubUserBasicModel>> {
        return manufacturingManagerRepository.getUserInWork(
            params
        )
    }
