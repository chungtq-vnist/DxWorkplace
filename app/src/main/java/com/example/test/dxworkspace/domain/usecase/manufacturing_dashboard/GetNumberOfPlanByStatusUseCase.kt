...
class GetNumberOfPlanByStatusUseCase @Inject constructor(
    val dashboardManufacturingRepository: DashboardManufacturingRepository,
    val configRepository: ConfigRepository
): UseCase<DashboardManufacturingPlanByStatus, ModelRequestDashboardPlan>() {
    override suspend fun run(params: ModelRequestDashboardPlan): Either<Failure, DashboardManufacturingPlanByStatus> {
        return dashboardManufacturingRepository.getNumberOfPlanByStatus(params.role,params.works,params.fromDate,params.toDate)
    }
