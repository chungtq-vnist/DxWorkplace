...
class CreateProductRequestManufacturingUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
) : UseCase<Boolean, ParamCreateProductRequest>() {
    override suspend fun run(params: ParamCreateProductRequest): Either<Failure, Boolean> {
        return manufacturingManagerRepository.createRequest(
            params
        )
    }
