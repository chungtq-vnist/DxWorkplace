...
class CreateExportBillsUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
): UseCase< Boolean, List<BillExportMaterialRequest>>() {
    override suspend fun run(params:List<BillExportMaterialRequest>): Either<Failure,  Boolean> {
       return manufacturingManagerRepository.createExportBill(params)
    }
