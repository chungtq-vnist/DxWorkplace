...
class UpdateQualityControlCommandUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
): UseCase< Boolean, Pair<RequestQualityControl, String>>() {
    override suspend fun run(params: Pair<RequestQualityControl , String>): Either<Failure,  Boolean> {
       return manufacturingManagerRepository.updateQualityControlCommand(params.first,params.second)
    }
