...
class GetAllStockUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
): UseCase< List<StockModel>, String>() {
    override suspend fun run(params:String): Either<Failure,  List<StockModel>> {
       return manufacturingManagerRepository.getStock()
    }
