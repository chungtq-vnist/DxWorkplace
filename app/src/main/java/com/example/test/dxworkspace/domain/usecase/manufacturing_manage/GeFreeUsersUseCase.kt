...
class GeFreeUsersUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
): UseCase< List<SubUserBasicModel>, Pair<List<String>,String>>() {
    override suspend fun run(params:Pair<List<String>,String>): Either<Failure,  List<SubUserBasicModel>> {
       return manufacturingManagerRepository.getFreeUsers(params.first,params.second)
    }
