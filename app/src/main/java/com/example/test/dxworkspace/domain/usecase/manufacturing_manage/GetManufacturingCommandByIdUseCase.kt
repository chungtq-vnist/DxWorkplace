...
class GetManufacturingCommandByIdUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
): UseCase<ManufacturingCommandModel, String>() {
    override suspend fun run(params: String): Either<Failure, ManufacturingCommandModel> {
        return manufacturingManagerRepository.getManufacturingCommandById(params)
    }
}