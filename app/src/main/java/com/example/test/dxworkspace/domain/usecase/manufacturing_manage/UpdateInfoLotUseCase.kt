...
class UpdateInfoLotUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
): UseCase< Boolean, Pair<String, RequestUpdateInfoLot>>() {
    override suspend fun run(params: Pair<String,RequestUpdateInfoLot>): Either<Failure,  Boolean> {
       return manufacturingManagerRepository.updateInfoLot(params.first,params.second)
    }
