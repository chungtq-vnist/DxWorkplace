...
) : UseCase<Boolean, ParamCreateWorkSchedule>() {
    override suspend fun run(params: ParamCreateWorkSchedule): Either<Failure,Boolean> {
        return manufacturingManagerRepository.createSchedule(
            params
        )
    }
