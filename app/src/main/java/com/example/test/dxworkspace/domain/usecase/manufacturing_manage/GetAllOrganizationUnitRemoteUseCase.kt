...
class GetAllOrganizationUnitRemoteUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
): UseCase<List<OrganizationUnit>, String>() {
    override suspend fun run(params: String): Either<Failure, List<OrganizationUnit>> {
        return manufacturingManagerRepository.getAllOrganizationUnitRemote()
    }
}