...
class GetManufacturingMillUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
): UseCase<List<ManufacturingMillEntity>, String>() {
    override suspend fun run(params: String): Either<Failure, List<ManufacturingMillEntity>> {
        val t = manufacturingManagerRepository.getAllMillsFromDb()
