...
class GetApprovesOfPlanByRoleUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
): UseCase< List<UserRoleInOrganizationUnit>, String>() {
    override suspend fun run(params:String): Either<Failure,  List<UserRoleInOrganizationUnit>> {
       return manufacturingManagerRepository.getApprovesOfPlanByRole(params)
    }
