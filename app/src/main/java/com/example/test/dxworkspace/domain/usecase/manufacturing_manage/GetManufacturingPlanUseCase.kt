...
class GetManufacturingPlanUseCase @Inject constructor(
    val manufacturingManagerRepository: ManufacturingManagerRepository,
    val configRepository: ConfigRepository
): UseCase< List<ManufacturingPlanModel>, Pair<String,String>>() {
    override suspend fun run(params: Pair<String,String>): Either<Failure,  List<ManufacturingPlanModel>> {
       return manufacturingManagerRepository.getAllPlan(params.first , params.second)
    }
