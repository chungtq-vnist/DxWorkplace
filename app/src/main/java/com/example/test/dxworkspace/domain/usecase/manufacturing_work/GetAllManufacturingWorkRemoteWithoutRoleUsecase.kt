...
class GetAllManufacturingWorkRemoteWithoutRoleUsecase @Inject constructor(
    val manufacturingWorkRepository: ManufacturingWorkRepository,
    val configRepository: ConfigRepository
): UseCase<List<ManufacturingWorkModel>, String>() {
    override suspend fun run(params: String): Either<Failure, List<ManufacturingWorkModel>> {
        return manufacturingWorkRepository.getAllManufacturingWorksRemoteWithoutRole()
    }
